...
const { getTestPage, getPlansListing, getLoginPage, getHomePage, getProfilePage, getForgetPasswordPage,getResetPage,getSomethingWentWrong, getUpdateInfo} = require("../controller/viewController");
const { isUserLoggedIn, protectRoute, handleResetRequest, resetPassword } = require("../controller/authController");
// token
