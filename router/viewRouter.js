...
const { getCreatePlan,getUpdatePlan,getConfirmation,getSignupPage,getUsersListing, getPlansListing, getLoginPage, getHomePage, getProfilePage,getContactUs, getForgetPasswordPage,getResetPage,getSomethingWentWrong,getMyBookings, getUpdateInfo,getUpdateUser,plansListingUpdatable, getAllBookings, getAboutUs} = require("../controller/viewController");
...
viewRouter.get("/myBookings",protectRoute,getMyBookings)
